    ...
    <section className="relative w-full h-[650px] md:h-[750px] flex items-center overflow-hidden">
      ...
      <div className="max-w-[1500px] mx-auto w-full px-10 md:px-22 lg:px-34 relative z-10">
        <div className="max-w-3xl">
          {/* Badge */}
          <div className="inline-block mb-10 border border-[#B99630] px-4 py-1.5 rounded-full">
            <span className="text-[#B99630] text-[11px] md:text-[13px] font-light tracking-[4px] uppercase">
              JOIN OUR TEAM
            </span>
          </div>
          ...
          <div className="flex items-center gap-6 mb-12">
            <div className="w-12 h-[2px] bg-gradient-to-r from-[#D4A056] via-[#D4A056] to-transparent" />
            <span className="text-[#B99630] text-[13px] md:text-[15px] font-light tracking-[3px] uppercase">
              CAREERS
            </span>
          </div>
          ...
          <div className="space-y-6 mb-16">
            <p className="text-gray-200 text-[15px] md:text-[17px] font-light leading-relaxed max-w-xl font-sans">
          ...
          <button 
            ...
            className="bg-gradient-to-r from-[#BF9628] to-[#D2AA7F] text-white px-12 py-4 rounded-md font-medium tracking-[2px] uppercase text-[12px] hover:shadow-2xl transition-all flex items-center gap-3 group cursor-pointer"
          >
            VIEW CAREERS 
