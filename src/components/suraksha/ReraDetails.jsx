    ...
    <section className="bg-white py-14 md:py-20">
      ...
      <div className="max-w-[1080px] mx-auto px-5 md:px-6">
        ...
        <div className="text-center mb-9">
          ...
          {/* Horizontal Line */}
          <div className="w-20 h-[1.5px] bg-[#D4A056] mx-auto mt-5 opacity-80"></div>
        </div>
        ...
        <div className="bg-[#fdfcf5] rounded-lg border border-[#d8d2c5] shadow-[0_16px_40px_rgba(0,0,0,0.10)] overflow-hidden">
          ...
          <div className="px-6 md:px-10 py-5 border-b border-[#d8d2c5] bg-[#f4efe1]">
            ...
            <p className="text-[13px] md:text-[14px] text-gray-500">
              Suraksha Enclave Phase 1 - Official Information
            </p>
          </div>
          ...
          <div className="flex flex-col lg:flex-row">
            ...
            <div className="w-full lg:w-2/3 flex flex-col">
              ...
              <div className="flex flex-col sm:flex-row py-3.5 px-6 md:px-10 border-b border-[#d8d2c5] hover:bg-[#f4efe1] transition-colors duration-300">
                ...
                <a
                  href="https://up-rera.in/Projectsummary?UI0aPA1ISD=TtSlWe3y9BQ=&hfFlag=GL34ZTSSjlw=&NPJ6RAme=qIM3GCcBSIcdU2Mb8aB9kLVi4eSuPqPcxHpryMGzb58=&PaURJEMAN4=ZL9MNERkNdbheC1dUIt6gg==&IRSAHEB=D6PY3lyims8="
                  target="_blank"
