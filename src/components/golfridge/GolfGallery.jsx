...
const GolfGallery = () => {
  ...
  <span className="absolute left-1/2 -translate-x-1/2 bottom-0 w-[30%] h-[1px] bg-[#C5A267]"></span>
          ...
          {/* Slider Container */}
          <div className="relative group/golf-gallery px-1 md:px-0">
