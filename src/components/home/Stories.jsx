        ...
        <div className="flex justify-between items-end mb-10 md:mb-16">
          <div>
            ...
            <h2 className="text-3xl md:text-6xl font-rossanova font-bold text-white leading-tight">
              Stories of <br />
              <span className="font-playfair italic font-light text-[#C49B45]">Trust & Excellence</span>
            </h2>
          </div>
          ...
          >
            {testimonials.map((item) => (
              <SwiperSlide key={item.id} className="pb-10">
                ...
                {/* Original height, padding, and shapes are untouched */}
                <div
                ...
                >
                  <div>
                    <div className="flex gap-1 mb-5 md:mb-8">
                      {[...Array(item.stars)].map((_, i) => (
                        <span key={i} className="text-[#C49B45] text-[10px]">★</span>
                      ))}
                    </div>

                    {/* Font size scalable kiya hai taaki responsive me text h-[370px] ke bahar na nikle */}
                  ...
                  <div className="flex items-center gap-5 mt-auto">
                    ...
                    <div>
                      <h4 className="text-white font-bold text-sm md:text-base uppercase tracking-[0.1em] font-rossanova">{item.name}</h4>
                      <p className="text-gray-500 text-[10px] tracking-[0.2em] mt-1 font-semibold font-sans">{item.role}</p>
                    </div>
                  </div>
                </div>
              </SwiperSlide>
